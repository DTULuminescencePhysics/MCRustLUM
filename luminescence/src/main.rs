...
fn main() {
    ...
    let p1 = Coord::new(1.0, 5.0, 5.0, );
    let p2 = Coord::new(9.0, 5.0, 5.0, );
    ...
    println!("\n=== Integer Coordinates ===");
    let int_boundary = Boundary::new(10i32, 10i32, 10i32, false);
    let int_p1 = Coord::new(1i32, 5i32, 5i32, );
    let int_p2 = Coord::new(4i32, 5i32, 5i32, );
    let int_distance = int_boundary.distance(&int_p1, &int_p2);
    ...
    println!("\n=== Mixed Numeric Types ===");
    let mixed_boundary = Boundary::new(10i32, 10.0f32, 10i64, false);
    let mixed_p1 = Coord::new(1i32, 5.0f32, 5i64, );
    let mixed_p2 = Coord::new(4i32, 5.0f32, 5i64, );
    let mixed_distance = mixed_boundary.distance(&mixed_p1, &mixed_p2);
